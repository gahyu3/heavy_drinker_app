...
RSpec.describe 'NotificationSettings', type: :system do
  ...
  let(:notification_setting) { create(:notification_setting, user:) }
  let(:notification_setting_false) { create(:notification_setting, day: false, week: false, month: false, user:) }
